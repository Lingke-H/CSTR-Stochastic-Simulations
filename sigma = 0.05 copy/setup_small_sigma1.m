...
% 在这个区域，温度会自动升高 (自加速)
title('Figure 1: Zoomed-in Dynamics near Steady State', 'FontSize', 12);
...
figure(3);
plot(t, x_traj, 'k');
title('Figure 2: Time Evolution of x (Open Loop with Noise)', 'FontSize', 12);
xlabel('Time (t)');
...
title('Figure 4: Impact of Different Control Strategies on Probability Density', 'FontSize', 12);
...
save('simulation_data.mat'); % 把所有变量保存到文件